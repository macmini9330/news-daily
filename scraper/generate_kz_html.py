...
def generate_index(history: dict) -> str:
  ...
  <div class="rates-card">
    ...
    <table class="rates-table">
      <tr class="rates-head">
        <th class="r-cny">人民币</th>
        <th class="r-usd">美元</th>
        <th class="r-kzt">坚戈</th>
      </tr>
      <tr class="rates-body">
        <td class="r-val r-cny">{rates['cny']:.4f}</td>
...
.rates-card .rates-title {{ font-size: .92rem; font-weight: 700; color: #f0f6fc; text-align: center; margin-bottom: 10px; }}
.rates-table {{ width: 100%; border-collapse: collapse; font-size: .9rem; }}
.rates-table th {{ padding: 6px 8px; font-size: .95rem; font-weight: 400; text-align: center; border-bottom: 1px solid #21262d; }}
.rates-table td {{ padding: 8px 8px; text-align: center; font-weight: 400; font-size: 1.05rem; font-variant-numeric: tabular-nums; }}
